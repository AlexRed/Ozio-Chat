...
class JFormFieldTranschecker extends JFormField
	...
	protected function getLabel()
		...
		$msg_skel =
			...
			'Language files for %s language are still %s. We offer a OzioChat commercial license to language contributors. <a href="http://www.opensourcesolutions.es/en/docs/19-oziochat-documentation/30-language-support.html" target="_blank">Learn more.</a>' .
			'</span>' .
			'</div>';
