...
OzioChatPusherChatWidget._buildListItem = function(activity) {
  ...
  var msg_html = jQuery.emoticons.replace(message_text.html());
  var linkedText = Autolinker.link(msg_html, { newWindow: true, className: "oc-linked-text" } );
